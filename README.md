# Custom Go Challenges

I wanted to deepen my knowledge in go, on topics like data structures, network programming, distributed systems patterns, goroutines, channels. However, after a lot of research, I haven't found nothing on the web that could potentially help. So I decided to build one myself.

[🇺🇸 English](#-overview) | [🇧🇷 Português](#-visao-geral)
